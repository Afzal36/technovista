...
function WorkerDashboard() {
  ...
  useEffect(() => {
    setLoading(true);
  fetch("https://technovista-backend.onrender.com/api/issues/minimal-report")
      .then((res) => res.json())
      .then((data) => {
  ...
  const res = await fetch(`https://technovista-backend.onrender.com/api/issues/minimal-report/${reportId}`, {
        method: "PATCH",
              ...
              {report.status === "progress" && report.assignedTo === user.email && (
                <>
                  ...
                  <button
                    ...
                    onClick={async () => {
                      try {
                        const res = await fetch(`https://technovista-backend.onrender.com/api/issues/minimal-report/${report._id}`, {
                          method: "PATCH",
                          headers: { "Content-Type": "application/json" },
